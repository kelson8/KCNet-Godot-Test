...
@export_file("res://scenes/world_1.tscn") var game_scene_path : String
#@export_file("world_1.tscn") var game_scene_path : String
...
# Couldn't get this to work so I disabled it.
